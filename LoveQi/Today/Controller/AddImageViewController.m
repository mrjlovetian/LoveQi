...
- (UICollectionView *)collectionView {
    if (!_collectionView) {
        ...
        _collectionView = [[UICollectionView alloc] initWithFrame:CGRectMake(0, Navight, SCREEN_WIDTH, SCREEN_HEIGHT - Navight - self.bottomBtnView.height) collectionViewLayout:layout];
