...
//    [self.navigationController pushViewController:VC animated:YES];
    ...
    [BHBPopView showToView:self.view andImages:@[@"/biaoqing/smiley_002", @"/biaoqing/smiley_003", @"/biaoqing/smiley_011", @"/biaoqing/smiley_010", @"/biaoqing/smiley_010"] andTitles:@[@"生气", @"不开心", @"开心", @"喜欢", @"日记"] andSelectBlock:^(BHBItem *item) {
